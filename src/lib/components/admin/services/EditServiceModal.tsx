      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-1 flex-col gap-2">
            ...
            <input type="number" className={inputClass} min="1" step="5" value={editedService.duration ?? 30} onChange={(e) => set('duration', parseInt(e.target.value) || 30)} />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input type="number" className={inputClass} min="0" step="0.01" value={editedService.price ?? 0} onChange={(e) => set('price', parseFloat(e.target.value) || 0)} />
