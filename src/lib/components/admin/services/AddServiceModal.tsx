...
import { ALargeSmall, Tag, Clock, Euro, FileText } from 'lucide-react';
...
const emptyService = () => ({ name: '', category_id: '', price: 0, duration: 30, description: '' });
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-1 flex-col gap-2">
            ...
            <input type="number" className={inputClass} min="1" step="5" value={service.duration} onChange={(e) => set('duration', parseInt(e.target.value) || 30)} />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input type="number" className={inputClass} min="0" step="0.01" value={service.price} onChange={(e) => set('price', parseFloat(e.target.value) || 0)} />
