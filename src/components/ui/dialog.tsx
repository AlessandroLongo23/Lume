...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-10 -mb-10 flex flex-col-reverse gap-2 rounded-b-2xl border-t bg-muted/50 px-10 py-6 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
